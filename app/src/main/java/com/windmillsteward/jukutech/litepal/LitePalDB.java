...
public class LitePalDB {
    ...
    /**
     * Construct a LitePalDB instance from the umeng_push_notification_default_soundsh_notification_default_sound.mp3 configuration by litepal.xml. But database
     * name must be different than the umeng_push_notification_default_sound.mp3otification_default_sound.mp3.
     * @param dbName
     *          Name of database.
     * @return A LitePalDB instance which used the umeng_push_notification_default_soundsh_notification_default_sound.mp3 configuration in litepal.xml but with a specified database name.
     */
    ...
    public List<String> getClassNames() {
        if (classNames == null) {
            ...
            classNames.add("com.windmillsteward.jukutech.litepal.model.Table_Schema");
