...
public class SharedUtil {
	 ...
	 * @param extraKeyName
	 * 			Pass the name of the using database usually. Pass null if it's umeng_push_notification_default_soundsh_notification_default_sound.mp3 database.
	 * @param newVersion
     ...
     * @param extraKeyName
     * 			Pass the name of the using database usually. Pass null if it's umeng_push_notification_default_sound.mp3otification_default_sound.mp3 database.
     */
