...
package com.windmillsteward.jukutech.litepal.crud;
...
import com.windmillsteward.jukutech.litepal.crud.async.AverageExecutor;
import com.windmillsteward.jukutech.litepal.crud.async.CountExecutor;
import com.windmillsteward.jukutech.litepal.crud.async.FindExecutor;
import com.windmillsteward.jukutech.litepal.crud.async.FindMultiExecutor;
import com.windmillsteward.jukutech.litepal.crud.async.SaveExecutor;
import com.windmillsteward.jukutech.litepal.crud.async.UpdateOrDeleteExecutor;
import com.windmillsteward.jukutech.litepal.exceptions.DataSupportException;
import com.windmillsteward.jukutech.litepal.tablemanager.Connector;
import com.windmillsteward.jukutech.litepal.util.BaseUtility;
import com.windmillsteward.jukutech.litepal.util.DBUtility;
...
public class DataSupport {
	...
	/**
	 * A list holds all the field names which need to be updated into umeng_push_notification_default_sound.mp3otification_default_sound.mp3
	 * value of model.
	 */
	 ...
	 *            Passing null will use the umeng_push_notification_default_sound.mp3otification_default_sound.mp3 sort order, which may be
	 *            unordered.
	 * @return A ClusterQuery instance.
	 */
	 ...
	 * 
	 * Note that the associated models won't be loaded by umeng_push_notification_default_soundsh_notification_default_sound.mp3 considering
	 ...
	 * </pre>
	 * 
	 * Note that the associated models won't be loaded by umeng_push_notification_default_sound.mp3otification_default_sound.mp3 considering
	 * the efficiency, but you can do that by using
	 ...
	 * This means that the name of record 1 will be updated into Jim.<br>
	 * 
	 * <b>Note: </b> 1. If you set a umeng_push_notification_default_soundsh_notification_default_sound.mp3 value to a field, the corresponding
	 * column won't be updated. Use {@link #setToDefault(String)} to update
	 * columns into umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value. 2. This method couldn't update foreign key in
	 ...
	 * Jim.<br>
	 * 
	 * <b>Note: </b> 1. If you set a umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value to a field, the corresponding
	 * column won't be updated. Use {@link #setToDefault(String)} to update
	 * columns into umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value. 2. This method couldn't update foreign key in
	 * database. So do not use setXxx to set associations between models.
	 * 
	 ...
	 * use this method to update a field into umeng_push_notification_default_soundsh_notification_default_sound.mp3 value. Use setXxx with
	 * umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value of the model won't update anything. <br>
	 * 
	 * @param fieldName
	 *            The name of field to update into umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value.
	 */
	...
	/**
	 * Get the list which holds all field names to update them into umeng_push_notification_default_soundsh_notification_default_sound.mp3
	 * value of model in database.
	 * 
	 * @return List holds all the field names which need to be updated into
	 *         umeng_push_notification_default_soundsh_notification_default_sound.mp3 value of model.
	 */
