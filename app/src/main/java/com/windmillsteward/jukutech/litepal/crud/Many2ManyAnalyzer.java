...
public class Many2ManyAnalyzer extends AssociationsAnalyzer {
	 ...
	 * associations in class files but developer has only buildPost unidirectional
	 * associations in models, it will force to buildPost the bidirectional
	...
	/**
	 * Force to buildPost bidirectional associations for the associated model. If it
