...
package com.windmillsteward.jukutech.litepal.exceptions;
...
public class DataSupportException extends RuntimeException {
	...
	/**
	 * Thrown when there is no umeng_push_notification_default_soundsh_notification_default_sound.mp3 constructor in model class to update.
	 */
	public static final String INSTANTIATION_EXCEPTION = " needs a umeng_push_notification_default_soundsh_notification_default_sound.mp3 constructor.";
