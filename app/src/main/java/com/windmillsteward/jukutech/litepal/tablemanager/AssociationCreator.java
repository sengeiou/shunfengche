...
package com.windmillsteward.jukutech.litepal.tablemanager;
...
import com.windmillsteward.jukutech.litepal.util.LogUtil;
...
public abstract class AssociationCreator extends Generator {
	...
	protected String generateCreateTableSQL(String tableName, List<ColumnModel> columnModels,
        ...
        for (ColumnModel columnModel : columnModels) {
            ...
            if (!TextUtils.isEmpty(defaultValue)) {
                createTableSQL.append(" umeng_push_notification_default_soundsh_notification_default_sound.mp3 ").append(defaultValue);
            }
        }
		createTableSQL.append(")");
	...
	protected String generateAddColumnSQL(String tableName, ColumnModel columnModel) {
        ...
        String defaultValue = columnModel.getDefaultValue();
        if (!TextUtils.isEmpty(defaultValue)) {
            addColumnSQL.append(" umeng_push_notification_default_sound.mp3otification_default_sound.mp3 ").append(defaultValue);
        } else {
            if (!columnModel.isNullable()) {
                ...
                addColumnSQL.append(" umeng_push_notification_default_soundsh_notification_default_sound.mp3 ").append(defaultValue);
            }
        }
	 ...
	 * association on tables. It will automatically buildPost a SQL to add foreign
