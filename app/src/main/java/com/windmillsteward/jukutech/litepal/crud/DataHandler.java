...
import com.windmillsteward.jukutech.litepal.LitePalBase;
import com.windmillsteward.jukutech.litepal.annotation.Encrypt;
import com.windmillsteward.jukutech.litepal.crud.model.AssociationsInfo;
import com.windmillsteward.jukutech.litepal.exceptions.DataSupportException;
import com.windmillsteward.jukutech.litepal.exceptions.DatabaseGenerateException;
import com.windmillsteward.jukutech.litepal.tablemanager.model.GenericModel;
import com.windmillsteward.jukutech.litepal.util.BaseUtility;
import com.windmillsteward.jukutech.litepal.util.Const;
import com.windmillsteward.jukutech.litepal.util.DBUtility;
import com.windmillsteward.jukutech.litepal.util.cipher.CipherUtil;
...
import static com.windmillsteward.jukutech.litepal.util.BaseUtility.changeCase;
...
abstract class DataHandler extends LitePalBase {
	 ...
	 * field is with umeng_push_notification_default_soundsh_notification_default_sound.mp3 value or not.
	 */
	 ...
	 *            umeng_push_notification_default_sound.mp3otification_default_sound.mp3 sort order, which may be unordered.
	 * @param limit
	 ...
	 * basic data type or the corresponding object data type, return the umeng_push_notification_default_sound.mp3otification_default_sound.mp3
	 * data. Or return null.
	 * 
	 * @param modelClass
	 *            The original class the this constructor belongs to.
	 ...
	 * Check the value of field is umeng_push_notification_default_soundsh_notification_default_sound.mp3 value or not if current action is
	 * updating. If it's not umeng_push_notification_default_soundsh_notification_default_sound.mp3 value, put it into ContentValues. Otherwise
	 * ignore it.
	 * 
	 * @param baseObj
	 *            Current model to persist or update.
	...
	/**
	 * Analyze the passed in field. Check if this field is with umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value.
	 * The baseObj need a umeng_push_notification_default_sound.mp3otification_default_sound.mp3 constructor or {@link DataSupportException}
	 * will be thrown.
	 * 
	 * @param baseObj
	 *            Current model to update.
	 * @param field
	 *            To check if with umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value.
	 * @return If the field is with umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value, return true. Otherwise return
	 *         false.
	 * @throws IllegalAccessException
	 * @throws SecurityException
	 * @throws IllegalArgumentException
