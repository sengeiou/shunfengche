...
class LitePalOpenHelper extends SQLiteOpenHelper {
	 ...
	 *            The database file.
	 * @param factory
	 *            To use for creating cursor objects, or null for the umeng_push_notification_default_sound.mp3otification_default_sound.mp3
	 ...
	 * umeng_push_notification_default_soundsh_notification_default_sound.mp3.
	 *
	 * @param dbName
	 *            The database file.
	 * @param version
