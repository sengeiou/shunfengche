...
package com.windmillsteward.jukutech.litepal.util;
...
public class DBUtility {
     ...
     *          the umeng_push_notification_default_sound.mp3otification_default_sound.mp3 sort order, which may be unordered.
