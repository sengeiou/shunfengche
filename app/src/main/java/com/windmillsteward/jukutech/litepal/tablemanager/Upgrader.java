            ...
            for (ColumnModel columnModel : mTableModel.getColumnModels()) {
                if (columnModelDB.getColumnName().equalsIgnoreCase(columnModel.getColumnName())) {
                    ...
                    if (!hasConstraintChanged) {
                        ...
                        LogUtil.d(TAG, "umeng_push_notification_default_soundsh_notification_default_sound.mp3 value db is:" + columnModelDB.getDefaultValue() + ", umeng_push_notification_default_sound.mp3otification_default_sound.mp3 value is:" + columnModel.getDefaultValue());
