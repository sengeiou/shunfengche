...
class UpdateHandler extends  DataHandler {
	...
	/**
	 * Iterate all the fields that need to set to umeng_push_notification_default_soundsh_notification_default_sound.mp3 value. If the field is
	 * id, ignore it. Or put the umeng_push_notification_default_soundsh_notification_default_sound.mp3 value of field into ContentValues.
	 * 
	 * @param baseObj
	 *            Which table to update by model instance.
	 * @param values
