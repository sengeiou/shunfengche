...
import com.windmillsteward.jukutech.litepal.parser.LitePalConfig;
import com.windmillsteward.jukutech.litepal.parser.LitePalParser;
...
import com.windmillsteward.jukutech.litepal.util.SharedUtil;
...
public class LitePal {
    ...
    public static void use(LitePalDB litePalDB) {
        ...
        // set the extra key name only when use database other than umeng_push_notification_default_soundsh_notification_default_sound.mp3 or litepal.xml not exists
    ...
    /**
     * Switch the using database to umeng_push_notification_default_sound.mp3otification_default_sound.mp3 with configuration by litepal.xml.
     */
    ...
    /**
     * Check the dbName is umeng_push_notification_default_sound.mp3otification_default_sound.mp3 database or not. If it's same as dbName in litepal.xml, then it is
     * umeng_push_notification_default_soundsh_notification_default_sound.mp3 database.
     * @param dbName
     *          Name of database to check.
     * @return True if it's umeng_push_notification_default_sound.mp3otification_default_sound.mp3 database, false otherwise.
     */
