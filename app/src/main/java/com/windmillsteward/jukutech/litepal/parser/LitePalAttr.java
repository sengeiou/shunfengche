...
import com.windmillsteward.jukutech.litepal.exceptions.InvalidAttributesException;
...
public final class LitePalAttr {
	...
	/**
	 * Before application buildPost the connection with database, check the fields
