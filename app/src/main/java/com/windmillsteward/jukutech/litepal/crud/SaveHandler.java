 ...
 * there're some associated models already persisted, it will buildPost the
...
class SaveHandler extends  DataHandler {
	 ...
	 * model which is persisted will buildPost association with current model in
	 * database.
	 * 
	 * @param baseObj
	 ...
	 * associated model which is persisted will buildPost association with current
	 * model in database.
	 * 
	 * @param collection
