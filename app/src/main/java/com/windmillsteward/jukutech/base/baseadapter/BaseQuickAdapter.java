 ...
 */
package com.windmillsteward.jukutech.base.baseadapter;
...
import com.windmillsteward.jukutech.base.baseadapter.animation.AlphaInAnimation;
import com.windmillsteward.jukutech.base.baseadapter.animation.BaseAnimation;
import com.windmillsteward.jukutech.base.baseadapter.animation.ScaleInAnimation;
import com.windmillsteward.jukutech.base.baseadapter.animation.SlideInBottomAnimation;
import com.windmillsteward.jukutech.base.baseadapter.animation.SlideInLeftAnimation;
import com.windmillsteward.jukutech.base.baseadapter.animation.SlideInRightAnimation;
import com.windmillsteward.jukutech.base.baseadapter.entity.IExpandable;
import com.windmillsteward.jukutech.base.baseadapter.loadmore.LoadMoreView;
import com.windmillsteward.jukutech.base.baseadapter.loadmore.SimpleLoadMoreView;
import com.windmillsteward.jukutech.base.baseadapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * start up fetch position, umeng_push_notification_default_sound.mp3otification_default_sound.mp3 is 1.
     */
     ...
     * @param content
     */
    public void setLoadMoreEndText(String content) {
        setLoadMoreEndText(content, "");
    }

    private int mLoadMoreEndTextBgColor = -1;

    public void setLoadMoreEndTextBgColor(@IdRes int color) {
        mLoadMoreEndTextBgColor = color;
    }
     ...
     * @param content2
     */
    public void setLoadMoreEndText(String content1, String content2) {
    ...
    public BaseQuickAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
        ...
        setEmptyView(LayoutInflater.from(MyApplication.instance).inflate(R.layout.view_empty_order, null));
        setHeaderFooterEmpty(true, true);
    }

    public BaseQuickAdapter(@LayoutRes int layoutResId, @Nullable List<T> data, boolean needEmpty) {
        this.mData = data == null ? new ArrayList<T>() : data;
        if (layoutResId != 0) {
            this.mLayoutResId = layoutResId;
        }
    ...
    public BaseQuickAdapter(@Nullable List<T> data, boolean needEmpty) {
        this(0, data);
        if (needEmpty) {
            setEmptyView(LayoutInflater.from(MyApplication.instance).inflate(R.layout.view_empty_order, null));
            setHeaderFooterEmpty(true, true);
    ...
    public BaseQuickAdapter(@LayoutRes int layoutResId, boolean needEmpty) {
        this(layoutResId, null);
        if (needEmpty) {
            setEmptyView(LayoutInflater.from(MyApplication.instance).inflate(R.layout.view_empty_order, null));
            setHeaderFooterEmpty(true, true);
    ...
    private K getLoadingView(ViewGroup parent) {
        ...
        if (mLoadMoreEndTextBgColor != -1) {
            view.setBackgroundColor(mLoadMoreEndTextBgColor);
        }
        if (view != null) {
            TextView viewById1 = view.findViewById(R.id.tv_tips1);
            TextView viewById2 = view.findViewById(R.id.tv_tips2);
            if (viewById1 != null)
                if (!TextUtils.isEmpty(content1)) {
                    viewById1.setVisibility(View.VISIBLE);
                    viewById1.setText(content1);
                } else {
