...
public class MyPushIntentService extends UmengMessageService {
    ...
    public void onMessage(Context context, Intent intent) {
        try {
            ...
            UMRTLog.d(TAG, "message=" + message);    //消息体
            UMRTLog.d(TAG, "custom=" + msg.custom);    //自定义消息的内容
            UMRTLog.d(TAG, "title=" + msg.title);    //通知标题
            UMRTLog.d(TAG, "text=" + msg.text);    //通知内容
