...
public abstract class BaseLoadLayout extends FrameLayout implements State {
    ...
    public void retry() {
        if ( loadFailedListener != null )
            loadFailedListener.onLoadFailed();
    }
    ...
    private LoadFailedRetryListener loadFailedListener;

    public LoadFailedRetryListener getLoadFailedListener() {
        return loadFailedListener;
    }

    public void setLoadFailedListener(LoadFailedRetryListener loadFailedListener) {
