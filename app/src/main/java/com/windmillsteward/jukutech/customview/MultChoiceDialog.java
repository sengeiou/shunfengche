...
public class MultChoiceDialog {
    ...
    public MultChoiceDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public MultChoiceDialog setAdapter(TagAdapter<WelfareBean> adapter) {
        flowLayout.setAdapter(adapter);
        return this;
    }

    public MultChoiceDialog setOnListener(final OnListener listener) {
