...
public class CircleProgressBar extends View {
     ...
     * 第三个参数官方有这样的说明： defStyle - The umeng_push_notification_default_soundsh_notification_default_sound.mp3 style to apply to this view. If 0,
...
//        circlePaint.setShadowLayer(10, 10, 10, Color.RED);
    ...
    private void drawText(Canvas canvas, int center, int radius) {
        String percent = content;
        if(TextUtils.isEmpty(content))
            return;
        textPaint.setTextAlign(Paint.Align.CENTER); // 设置文字居中，文字的x坐标要注意
        textPaint.setColor(secondColor); // 设置文字颜色
        textPaint.setTextSize(15 * getScale()); // 设置要绘制的文字大小
