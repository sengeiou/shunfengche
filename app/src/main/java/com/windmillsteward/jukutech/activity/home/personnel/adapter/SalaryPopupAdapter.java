...
public class SalaryPopupAdapter extends BaseAdapter {

    private Context context;
    private List<SalaryBean> list;

    public SalaryPopupAdapter(Context context, List<SalaryBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvPopupItem.setText(list.get(position).getSalary_show());
