...
import com.windmillsteward.jukutech.activity.home.capitalmanager.activity.CapitalManagerActivityView;
import com.windmillsteward.jukutech.activity.home.houselease.activity.HouseRentingView;
 ...
 * 作者：xjh
 */
public class CapitalManagerActivityPresenter extends BaseNetModelImpl {

    private final int IS_AUTHEN=2;

    private CapitalManagerActivityView view;

    public CapitalManagerActivityPresenter(CapitalManagerActivityView view) {
        this.view = view;
    }
