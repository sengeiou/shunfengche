...
// * 作者：xjh
// */
//public class RequirePayActivity extends BaseActivity implements RequirePayView, View.OnClickListener {
//
...
//
//    private RequirePayPresenter presenter;
//    private PublishRequireModelBean payBean;
//    private RequirePayResultBean bean;
...
//        if (extras!=null) {
//            payBean = ((PublishRequireModelBean) extras.getSerializable(DATA));
//        }
//        presenter = new RequirePayPresenter(this);
//        if (payBean==null) {
//            finish();
//            return;
//        }
//        presenter.initPay(payBean.getAccess_token(),payBean.getRequire_class_id(),payBean.getTitle(),payBean.getPrice(),
//                payBean.getDescription(),payBean.getSecond_area_id(),payBean.getThird_area_id(),payBean.getLongitude(),payBean.getLatitude(),
//                payBean.getPic_urls(),payBean.getVideo_url(),payBean.getVideo_cover(),payBean.getCoupon_receive_id(),payBean.getOrder_sn());
//
//    }
//
//    @Override
...
//            if (extras!=null) {
//                receive_id = extras.getInt(Define.RECEIVE_ID);
//                tv_coupon_receive_id.setText((receive_id==0)?"不使用":"已选择优惠券");
//                presenter.initPay(payBean.getAccess_token(),payBean.getRequire_class_id(),payBean.getTitle(),payBean.getPrice(),
//                        payBean.getDescription(),payBean.getSecond_area_id(),payBean.getThird_area_id(),payBean.getLongitude(),payBean.getLatitude(),
//                        payBean.getPic_urls(),payBean.getVideo_url(),payBean.getVideo_cover(),receive_id,bean.getOrder_sn());
//            }
//        }
//    }
//
...
//
//    @Override
//    public void initDataSuccess(RequirePayResultBean bean) {
