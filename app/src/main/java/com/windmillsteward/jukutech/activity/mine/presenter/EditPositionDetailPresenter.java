...
import com.windmillsteward.jukutech.activity.mine.activity.EditPositionDetailView;
...
public class EditPositionDetailPresenter extends BaseNetModelImpl {

    private final int INIT_DATA = 1;
    private final int IS_CHARGE=6;
    private final int DELETE_POSITION=7;

    private EditPositionDetailView view;

    public EditPositionDetailPresenter(EditPositionDetailView view) {
        this.view = view;
    }
