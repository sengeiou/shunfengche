...
import com.windmillsteward.jukutech.activity.newpage.order.OrderListFragment;
...
public class WalletListActivity extends BaseActivity implements View.OnClickListener, WalletListView {
    ...
    private int type = 0;//类型【0.全部明细,1.收入,2.支出,3.退款,4.提现】
    private int page;
...
//        toolbar_iv_title.setOnClickListener(this);
        ...
        mTitleDataList.add("收入");
        mTitleDataList.add("支出");
        mTitleDataList.add("退款");
        mTitleDataList.add("提现");
...
//        });
        ...
        presenter = new WalletDetailListPresenter(this);
        ...
        new SimpleListDialog(this).builder().setAdapter(new SimpleListDialogAdapter(this, maps))
                .setSelectListener(new SimpleListDialog.OnSelectListener() {
                    ...
                    public void onSelect(int id, int pos, String text) {
                        WalletListActivity.this.type = id;
