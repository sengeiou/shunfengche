...
import com.windmillsteward.jukutech.activity.chat.model.styles.EaseMessageListItemStyle;
...
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatBigExpressionPresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatFilePresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatImagePresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatLocationPresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatRowPresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatTextPresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatVideoPresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.EaseChatVoicePresenter;
import com.windmillsteward.jukutech.activity.chat.widget.presenter.RedPacketPresenter;
...
public class EaseMessageAdapter extends BaseAdapter{
	...
	public int getItemViewType(int position) {
		...
		if (message.getType() == EMMessage.Type.TXT) {
		    ...
		    else if (message.getBooleanAttribute(EaseConstant.RED_PACKET,false)){
	...
	protected EaseChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        ...
        case TXT:
            if(message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
				...
				presenter = new RedPacketPresenter();
			} else{
