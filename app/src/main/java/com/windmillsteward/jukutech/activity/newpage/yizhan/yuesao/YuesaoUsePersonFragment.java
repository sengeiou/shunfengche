 ...
 * 月嫂-用工明细
 */
public class YuesaoUsePersonFragment extends BaseInitFragment {
    public static final String TAG = "YuesaoUsePersonFragment";
    ...
    protected int getContentViewId() {
        return R.layout.fragment_yuesao_use_person;
    }
