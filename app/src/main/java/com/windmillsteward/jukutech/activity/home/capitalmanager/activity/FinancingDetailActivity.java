...
public class FinancingDetailActivity extends BaseActivity implements CapitalDetailActivityView, View.OnClickListener {
    ...
    public void initDataSuccess(CapitalDetailBean bean) {
        ...
        tv_product_name.setText(bean.getTitle());
            ...
            case R.id.linear_call:
                if (isLogin()) {
                    if (detailBean != null) {
                        ...
                        presenter.isCharge(getAccessToken(), 83, capital_id);
                    }
                } else {
