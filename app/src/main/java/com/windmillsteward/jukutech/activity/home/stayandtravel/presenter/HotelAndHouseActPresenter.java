...
import com.windmillsteward.jukutech.activity.home.stayandtravel.activity.HotelAndHouseListView;
 ...
 * 作者：xjh
 */
public class HotelAndHouseActPresenter extends BaseNetModelImpl {
    private final int IS_AUTHEN=2;

    private HotelAndHouseListView view;

    public HotelAndHouseActPresenter(HotelAndHouseListView view) {
        this.view = view;
    }
