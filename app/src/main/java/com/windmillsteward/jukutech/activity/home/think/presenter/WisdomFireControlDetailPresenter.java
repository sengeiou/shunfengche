...
import com.windmillsteward.jukutech.activity.home.think.activity.WisdomFireControlDetailView;
...
public class WisdomFireControlDetailPresenter extends BaseNetModelImpl {
    ...
    private WisdomFireControlDetailView view;

    public WisdomFireControlDetailPresenter(WisdomFireControlDetailView view) {
        this.view = view;
    }

    public void initData(String access_token,int consumption_id){
        view.showDialog("");
        ...
        map.put("consumption_id", consumption_id);
        httpInfo.setUrl(APIS.URL_SMART_FIRE_DETAIL);
        httpInfo.setParams(map);
        dataLoader.httpPost(httpInfo);
    }

    public void collect(String access_token,int consumption_id){
        view.showDialog("");
        ...
        map.put("access_token", access_token);
        map.put("consumption_id", consumption_id);
        httpInfo.setUrl(APIS.URL_COLLECT);
        httpInfo.setParams(map);
        dataLoader.httpPost(httpInfo);
    }
    public void cancelCollect(String access_token,int consumption_id){
        view.showDialog("");
        ...
        map.put("access_token", access_token);
        map.put("consumption_id", consumption_id);
        httpInfo.setUrl(APIS.URL_CANCEL_COLLECT);
        httpInfo.setParams(map);
        dataLoader.httpPost(httpInfo);
    }
