...
public class QuickIndexCityAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<AreaBean> names;

    public QuickIndexCityAdapter(Context context, ArrayList<AreaBean> names) {
