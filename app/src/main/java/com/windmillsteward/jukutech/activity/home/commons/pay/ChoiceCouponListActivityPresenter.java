 ...
 * 作者：xjh
 */
public class ChoiceCouponListActivityPresenter extends BaseNetModelImpl {

    private static final int INIT_DATA = 1;
    private static final int NEXT_DATA = 2;
    private static final int REFRESH_DATA = 3;

    private ChoiceCouponListActivityView view;

    public ChoiceCouponListActivityPresenter(ChoiceCouponListActivityView view) {
        this.view = view;
    }
    /**
     * 初始化数据
