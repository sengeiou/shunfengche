...
public class MyCouponOutOfDateFragment extends BaseFragment implements MyCouponView {
    ...
    public static MyCouponOutOfDateFragment getInstance(int status) {
        MyCouponOutOfDateFragment fragment = new MyCouponOutOfDateFragment();
