...
public class QuickIndexStreetAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<FourthAreaBean> names;

    public QuickIndexStreetAdapter(Context context, ArrayList<FourthAreaBean> names) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FourthAreaBean person = names.get(position);

        holder.tv_Index.setText(person.getPinyin().charAt(0) + "");
        holder.tv_name.setText(person.getFourth_area_name());
        return convertView;
    }
