...
public class CarDetailActivityPresenter extends BaseNetModelImpl {
    ...
    public CarDetailActivityPresenter(CarDetailActivityView view) {
        this.view = view;
    }
    ...
    public void collect(int car_id,String access_token) {
        view.showDialog("");
    ...
    public void cancelCollect(int car_id,String access_token) {
        view.showDialog("");
