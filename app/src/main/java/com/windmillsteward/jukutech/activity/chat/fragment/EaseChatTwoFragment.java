...
import com.windmillsteward.jukutech.activity.chat.activity.EaseBaiduMapActivity;
import com.windmillsteward.jukutech.activity.chat.activity.SendRedPacketActivity;
...
import com.windmillsteward.jukutech.activity.chat.model.EaseCompat;
import com.windmillsteward.jukutech.activity.chat.model.EaseDingMessageHelper;
import com.windmillsteward.jukutech.activity.chat.ui.EaseBaseFragment;
import com.windmillsteward.jukutech.activity.chat.ui.EaseChatRoomListener;
...
import com.windmillsteward.jukutech.activity.chat.widget.EaseChatExtendMenu;
import com.windmillsteward.jukutech.activity.chat.widget.EaseChatInputMenu;
import com.windmillsteward.jukutech.activity.chat.widget.EaseChatMessageList;
import com.windmillsteward.jukutech.activity.chat.widget.EaseVoiceRecorderView;
import com.windmillsteward.jukutech.activity.chat.widget.chatrow.EaseCustomChatRowProvider;
 ...
 */
public class EaseChatTwoFragment extends EaseBaseFragment implements EMMessageListener {
    protected static final String TAG = "EaseChatTwoFragment";
    protected static final int REQUEST_CODE_MAP = 1;
    protected static final int REQUEST_CODE_CAMERA = 2;
    protected static final int REQUEST_CODE_LOCAL = 3;
    protected static final int REQUEST_CODE_DING_MSG = 4;
    protected static final int REQUEST_CODE_RED_PACKET = 5;
...
//            ITEM_LOCATION,
    ...
    protected void initView() {
        ...
        titleBar.setBackgroundColor(getActivity().getResources().getColor(R.color.white));
        // message list layout
...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.ease_mm_title_remove_black);
        } else {
            titleBar.setRightImageResource(R.drawable.ease_conversation_selected);
...
//                }
            ...
            public boolean onBubbleClick(EMMessage message) {
                Log.e(TAG, "onBubbleClick: " + "1515151551");
                if (chatFragmentHelper == null) {
                    return false;
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_CAMERA) { // capture new image
                ...
                sendMessage(dingMsg);
            } else if (requestCode == REQUEST_CODE_RED_PACKET) { // To send the 红包 msg.
//                String msgContent = data.getStringExtra("msg");
//                EMLog.i(TAG, "To send the red packet msg, content: " + msgContent);
                //发送扩展消息
                if (data != null) {
...
//                    String packet_desc = data.getStringExtra(EaseConstant.PACKET_DESC);
                    ...
                    EMMessage message = EMMessage.createTxtSendMessage("[顺风车管家红包]" + resultModel.getPacket_desc(), toChatUsername);
                    //增加自己的属性
                    message.setAttribute(EaseConstant.RED_PACKET, true);
                    if (resultModel != null) {
                        message.setAttribute(EaseConstant.RED_PACKET_ID, resultModel.getRelate_id());
                        message.setAttribute(EaseConstant.PACKET_DESC, resultModel.getPacket_desc());
                        message.setAttribute(EaseConstant.USER_AVATAR_URL, resultModel.getUser_avatar_url());
                    }
                    sendMessage(message);
                }
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_LOCATION:
                    ...
                    break;
                case ITEM_RED_PACKET://红包icon
                    Intent intent = new Intent(getActivity(), SendRedPacketActivity.class);
                    intent.putExtra(SendRedPacketActivity.CHAT_TYPE, chatType);
    ...
    protected void sendImageMessage(String imagePath) {
        ...
        UserInfo userInfo = (UserInfo) Hawk.get(Define.USER_INFO);
        if (userInfo != null) {
            message.setAttribute(EaseConstant.USER_AVATAR_URL, userInfo.getUser_avatar_url());
        }
        sendMessage(message);
    }
