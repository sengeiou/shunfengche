...
import com.windmillsteward.jukutech.activity.mine.presenter.EditResumeDetailPresenter;
 ...
 * 作者：xjh
 */
public class EditResumeDetailActivity extends BaseActivity implements EditResumeDetailView, View.OnClickListener {
    ...
    private EditResumeDetailPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initToolbar();
        presenter = new EditResumeDetailPresenter(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.linear_edit:
                if (detailBean!=null) {
                    Bundle bundle = new Bundle();
                    bundle.putInt(PublishJobWantedActivity.TYPE,1);
                    bundle.putSerializable(PublishJobWantedActivity.DATA,detailBean);
                    startAtvDonFinish(PublishJobWantedActivity.class,bundle);
                }
                break;
        }
    }
