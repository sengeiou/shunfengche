...
import com.windmillsteward.jukutech.activity.home.personnel.activity.MyResumeDetailView;
...
public class MyResumeDetailPresenter extends BaseNetModelImpl {
    ...
    private MyResumeDetailView view;

    public MyResumeDetailPresenter(MyResumeDetailView view) {
        this.view = view;
    }
