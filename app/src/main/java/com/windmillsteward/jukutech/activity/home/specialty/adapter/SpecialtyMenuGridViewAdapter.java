...
public class SpecialtyMenuGridViewAdapter extends BaseAdapter {

    private Context context;
    private List<SpecialtyClassBean> lists;//数据源
    private int mIndex; // 页数下标，标示第几页，从0开始
    private int mPargerSize;// 每页显示的最大的数量


    public SpecialtyMenuGridViewAdapter(Context context, List<SpecialtyClassBean> lists,
    ...
    @Override
    public SpecialtyClassBean getItem(int arg0) {
        // TODO Auto-generated method stub
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.item_specialty_viewpage_gridview, null);
