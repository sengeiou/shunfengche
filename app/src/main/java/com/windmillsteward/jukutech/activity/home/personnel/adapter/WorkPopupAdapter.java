...
public class WorkPopupAdapter extends BaseAdapter {

    private Context context;
    private List<MoreBean.WordYearListBean> list;
    private int select=-1;

    public WorkPopupAdapter(Context context, List<MoreBean.WordYearListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_more.setText(list.get(position).getWork_year_show());
