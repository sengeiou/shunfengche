...
import com.windmillsteward.jukutech.activity.mine.presenter.ShoppingContinuePayActivityPresenter;
 ...
 * 作者：xjh
 */
public class ShoppingContinuePayActivity extends BaseActivity implements ShoppingContinuePayActivityView, View.OnClickListener {
    ...
    private ShoppingContinuePayActivityPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras!=null) {
            total_pay_fee = extras.getString(Define.INTENT_DATA);
            order_sn = extras.getString(Define.INTENT_DATA_TWO);
            store_name = extras.getString(Define.INTENT_DATA_THREE);
        } else {
            finish();
            return;
        }
        ...
        presenter = new ShoppingContinuePayActivityPresenter(this);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==100 && resultCode==200) {
            ...
            if (extras!=null) {
                ...
                if (bean!=null) {
                    presenter.userCouponPay(getAccessToken(),order_sn,receive_id);
                }
            }
        }
    }
...
//        }
        ...
        bean = new ShoppingPayBean();
        bean.setOrder_sn(order_sn);
        bean.setOrder_title(store_name);
        bean.setTotal_pay_fee(total_pay_fee);
        tv_order_price.setText("￥" + bean.getTotal_pay_fee());
        tv_order_sn.setText(bean.getOrder_sn());
        tv_order_name.setText(bean.getOrder_title());
...
//                    aliParam.billTitle = bean.getOrder_title();
...
//                        payParams.billTitle = bean.getOrder_title();   //订单标题
...
//    };
    ...
    @Override
    public void payBefore(ShoppingPayBean bean) {
        this.bean = bean;
        tv_order_price.setText("￥" + bean.getTotal_pay_fee());
        tv_order_sn.setText(bean.getOrder_sn());
        tv_order_name.setText(bean.getOrder_title());
