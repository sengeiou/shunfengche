    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_license:  // 选择营业执照
                new BottomDialog(PublishHotelActivity.this, new BottomDialog.OnSelectListener() {
                    @Override
...
//                        takePhoto.onPickFromCaptureWithCrop(imageUri,getCropOptions());
    ...
    public void uploadIdCardSuccess_b(List<String> idCard_url_b) {
        if (idCard_url_b!=null && idCard_url_b.size()>0) {
            ...
            presenter.publish(getAccessToken(),1,pic_urls,hotel_name,hotel_type,opening_date,customer_service_phone,getCurrCityId(),third_area_id,
