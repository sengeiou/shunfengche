...
import com.windmillsteward.jukutech.activity.mine.activity.ShoppingContinuePayActivityView;
 ...
 * 作者：xjh
 */
public class ShoppingContinuePayActivityPresenter extends BaseNetModelImpl {

    private static final int BEFORE_PAY = 0;
    private static final int AFTER_PAY = 1;

    public ShoppingContinuePayActivityView view;

    public ShoppingContinuePayActivityPresenter(ShoppingContinuePayActivityView view) {
        this.view = view;
    }
