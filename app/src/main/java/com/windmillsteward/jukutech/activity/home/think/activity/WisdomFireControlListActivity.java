...
import com.windmillsteward.jukutech.activity.home.think.fragment.WisdomFireControlListFragment;
...
/**
 * 描述：智慧消防列表
 * 时间：2018年7月31日 23:25:49
 * 作者：lc
 */
public class WisdomFireControlListActivity extends BaseActivity implements View.OnClickListener,IdeaThinkListView {
    ...
    private WisdomFireControlListFragment ideaThinkListFragment;
    ...
    private void initFragment() {
        ideaThinkListFragment = WisdomFireControlListFragment.getInstance("", curr_type);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.linear_search:
                SearchItemActivity.go(this,81,0);
                break;
        }
    }
    ...
    public void isAuthen(AuthenResultBean bean) {
        if (bean!=null) {
            if (bean.getIs_authen()==1) {
                startAtvDonFinish(PublishWisdomFireControlListActivity.class);
