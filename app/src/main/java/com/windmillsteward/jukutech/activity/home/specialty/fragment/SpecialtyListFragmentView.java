...
public interface SpecialtyListFragmentView extends BaseViewModel {


    /**
     * 初始化数据
     */
    void initDataSuccess(SpecialtyListBean bean);

    /**
     * 刷新
     * @param bean
     */
    void refreshDataSuccess(SpecialtyListBean bean);
     ...
     * @param bean
     */
    void loadNextDataSuccess(SpecialtyListBean bean);
