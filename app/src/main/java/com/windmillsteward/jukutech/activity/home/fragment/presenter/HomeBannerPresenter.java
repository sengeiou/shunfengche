...
import com.windmillsteward.jukutech.activity.home.fragment.HomeBannerView;
...
public class HomeBannerPresenter extends BaseNetModelImpl {

    private final int TOP_BANNER = 1;
    private final int MIDDLE_BANNER = 2;
    private HomeBannerView view;
    private Context context;

    public HomeBannerPresenter(Context context, HomeBannerView view) {
    ...
    public void getBannerMiddleList(int banner_position) {
        DataLoader dataLoader = new DataLoader(this, MIDDLE_BANNER);
        HttpInfo httpInfo = new HttpInfo();
        Map<String, Object> map = new TreeMap<String, Object>();
        map.put("banner_position", banner_position);
        httpInfo.setUrl(APIS.URL_BANNER_LIST);
    ...
    protected void onDataCallback(int code, int action, BaseResultInfo result, String sourceData) {
        ...
        switch (action) {
            case TOP_BANNER:
                ...
                break;
            case MIDDLE_BANNER:
                List<SliderPictureInfo> middleList = (List<SliderPictureInfo>) result.getData();
                view.getMiddleBannerListSuccess(middleList);
                break;
        }
    }
    ...
    protected void requestFailed(int code, int action, String msg, String sourceData) {
        ...
        switch (action) {
            case TOP_BANNER:
                view.getTopBannerListFailed(code, msg);
                break;
            case MIDDLE_BANNER:
                view.getMiddleBannerListFailed(code, msg);
                break;
        }
    }
}
